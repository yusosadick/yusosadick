...
const REPO_DETAILS = {
  owner: process.env.CI_REPOSITORY_OWNER || "yusosadick",
  repo: process.env.CI_REPOSITORY_OWNER || "yusosadick",
};
...
function generateStuffInsideFences(data) {
  ...
  <ul>
  ${renderedList}
  <li><a href="https://github.com/yusosadick/yusosadick/issues/new?assignees=&labels=&template=endorsement-template.md&title=Endorse%3A+SKILL_HERE">Endorse new skill!</a></li>
  </ul>
  ${END_COMMENT}`;
